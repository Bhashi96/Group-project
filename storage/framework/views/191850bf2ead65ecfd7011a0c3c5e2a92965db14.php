...
<head>
    ...
    <title>travel freak home</title>
</head>
<body>

<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <a href="" class="navbar-brand"><img src="images/smlogo.jpg" class="mx-auto d-block image-fluid" alt=""></a>
    <a href="" class="navbar-brand">Travel Freak</a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="cd01">
            <ul class="navbar-nav">
                    ...
                    <li class="nav-item active"><a href="index.html" class="nav-link disable">Home</a>  </li>
                    <li class="nav-item"><a href="" data-toggle="modal" data-target="#loginModalMoreContent"class="nav-link">Log In</a>  </li>
                    <li class="nav-item"><a href="registrations/tourist_reg.html" class="nav-link">Register</a>  </li>
                    <li class="nav-item"><a href="" class="nav-link">Forum</a>  </li>
                    <li class="nav-item"><a href="map.html" class="nav-link">Tourist Map</a>  </li>
...
<div class="jumbotron jumbotron-fluid">
	...
	<p class="lead text-center mt-5">Individual .carousel-item interval</p>PUT YOUR ANNOUNCEMENTS HERS.
</div>
</div>
...
<div class="container mt-3">
        ...
        <br><br>
        <h1 class="text-center lead bold">Site addvertisements</h1>
        <br><br>
        <div class="card-deck">
            <div class="card">
                <img src="images/gallefort" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card">
                <img src="images/sigiriya" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
            ...
            <div class="card">
                <img src="images/ga" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
...
<footer class="page-footer font-small bg-dark  pt-4">
    ...
    <div class="container text-center text-md-left">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3 mr-auto my-md-4 my-0 mt-4 mb-1">
          ...
          <!-- Content -->
          <h5 class="font-weight-bold text-uppercase text-white bg-dark mb-4">Travel Freak</h5>
          <p class="text-white bg-dark">We cover your all traveling needs.</p>
          <p class="text-white bg-dark">Enjoy your life...</p>
        ...
        <div class="col-md-2 col-lg-2 mx-auto my-md-4 my-0 mt-4 mb-1">
          ...
          <!-- Links -->
          <h5 class="font-weight-bold text-uppercase text-white bg-dark mb-4">About</h5>
        ...
        <div class="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1">
          ...
          <!-- Contact details -->
          <h5 class="font-weight-bold text-uppercase text-white bg-dark mb-4">Address</h5>
  
          <ul class="list-unstyled">
            <li>
              <p class="text-white bg-dark">
                <i class="fa fa-home mr-3 "></i>No 17,Field Avenue,Colombo 7</p>
            </li>
            <li>
              <p class="text-white bg-dark">
                <i class="fa fa-envelope mr-3 "></i> travelfreak@gmail.com</p>
            </li>
            <li>
              <p class="text-white bg-dark">
                <i class="fa fa-phone mr-3 "></i> + 94776548723</p>
            </li>
        ...
        <div class="col-md-2 col-lg-2 text-center mx-auto my-4">
          ...
          <!-- Social buttons -->
          <h5 class="font-weight-bold text-uppercase text-white bg-dark mb-4">Follow Us</h5>
  
          <!-- Facebook -->
          <a type="button" class="btn-floating btn-fb text-primary">
            <i class="fa fa-facebook-f"></i>
          </a>
          <!-- Twitter -->
          <a type="button" class="btn-floating btn-tw text-primary">
            <i class="fa fa-twitter"></i>
          </a>
          <!-- Google +-->
          <a type="button" class="btn-floating btn-gplus text-danger">
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center text-white bg-dark lighten-3 py-3">© 2018 Copyright:
      <a href="https://mdbootstrap.com/education/bootstrap/"> travelfreak.com</a>
    </div>
    <!-- Copyright -->
...
</html><?php /**PATH C:\Users\Bhashitha\Documents\laravel project\group_project\resources\views/check.blade.php ENDPATH**/ ?>