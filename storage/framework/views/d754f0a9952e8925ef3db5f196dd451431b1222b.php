...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Register as Driver')); ?></div>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            <label for="vrn" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Vehicle reg No')); ?></label>

                            <div class="col-md-6">
                                <input id="vrn" type="text" class="form-control <?php if ($errors->has('vrn')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('vrn'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="vrn" value="<?php echo e(old('vrn')); ?>" required autocomplete="vrn" autofocus>

                                <?php if ($errors->has('vrn')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('vrn'); ?>
                                    <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($message); ?></strong>
                                    </span>
                                <?php unset($message);
...
if (isset($messageCache)) { $message = $messageCache; }
                      ...
                      <div class="form-group row">
                           ...
                           <div class="col-md-6">
                               <input id="user_type" type="hidden"  name="user_type" value="<?php echo e(__('drv')); ?>" required autocomplete="user_type">
...
<?php echo $__env->make('layouts.reglayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Bhashitha\Documents\GitHub\Group-project\resources\views/pages/registrations/driver_reg.blade.php ENDPATH**/ ?>